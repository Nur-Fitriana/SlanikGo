...
export default function InfoScreen() {
  ...
  const bukaPeta = async () => {
    const url = "https://goo.gl/maps/SlanikWaterparkLampung";
    const bisaBuka = await Linking.canOpenURL(url);
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollView}>
        ...
        {/* 🌟 KUNCI UTAMA: Hero Banner sengaja ditaruh di luar wrapper agar bisa melesat FULL WIDTH 100% ke ujung monitor */}
        <View style={styles.heroContainer}>
          ...
          <View style={styles.heroGradientOverlay}>
            {/* Batas teks di dalam banner disamakan dengan lebar konten bawah */}
        ...
        {/* 🌟 KUNCI KEDUA: Wrapper ini hanya mengunci susunan grid box di bawah agar tidak melar kesamping */}
...
const styles = StyleSheet.create({
  ...
  // Pengaturan Banner Atas agar loss 100% tanpa sekat kanan-kiri
  heroContainer: {
    width: "100%",
    height: width > 768 ? 440 : 280, 
    position: "relative",
  ...
  heroMainTitle: { color: "#FFF", fontSize: width > 768 ? 42 : 28, fontWeight: "900", letterSpacing: -0.5 },
  heroSubTitle: { color: "#F1F5F9", fontSize: width > 768 ? 15 : 13, marginTop: 6, fontWeight: "500", maxWidth: 650, lineHeight: 22 },
  ...
  // Hanya mengunci bagian container box informasi bawah agar rapi di tengah monitor PC
  webCenteringWrapper: {
    width: "100%",
    maxWidth: width > 1024 ? 1100 : "100%",
    alignSelf: "center",
  ...
  fullWebBody: {
    paddingHorizontal: "6%",
    paddingTop: 35,
    paddingBottom: 120, // Ruang aman di atas Floating Tab Bar melayang Anda
  },
  sectionBlock: {
    marginBottom: 35,
  },
  ...
  scheduleSubTitle: { fontSize: 12, color: "#64748B", marginTop: 2 },
  timePillBlue: {
  ...
  csRoleSub: { fontSize: 12, color: "#94A3B8", textAlign: "center", marginTop: 4, fontWeight: "500" },
  actionChatBadge: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "#E0F2FE",
